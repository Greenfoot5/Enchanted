...
public class WeightedPrefabEditor : PropertyDrawer
{
    /// <summary>
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        var prefabInputRect = new Rect(position) { width = prefabFieldPercent * position.width };
        ...
        EditorGUI.PropertyField(prefabInputRect, prefabProp, GUIContent.none);
